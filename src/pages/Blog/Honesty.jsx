...
const Honesty = () => {
  return (
    <div className='post'>
        ...
        They say what they think other people would want to hear in order to make them happy. In all of these examples I chose, the person has good intentions. 
        But it's these lies, lies that are based off of good intentions, that I believe are the most common and thus the most harmful. 
        I'm not saying that lying for your own self interest is any better. The vast majority of people already understand that lying in general is wrong. 
        But somewhere down the line in the so-called complexity do we reason that lying is permissible from situation to situation. And with a caveat like 
        that with no underlying principle, lying quickly becomes the norm. 
        </p>

        <p>
        Allow me to reduce the complexity:
        </p>

        <p className="centered-text">
        In all circumstances, lying is wrong. Adopt a principle of <span>Radical Honesty</span>. 
        </p>
